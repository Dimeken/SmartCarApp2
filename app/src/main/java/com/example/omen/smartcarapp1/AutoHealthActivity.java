...
public class AutoHealthActivity extends AppCompatActivity implements View.OnClickListener{
    ImageButton btnBack;
    TextView navHeaderName,navHeaderCar;
    DrawerLayout mDrawerLayout;
    SharedPreferences sPref;
    SharedPreferences.Editor editor;
    RelativeLayout relDiagnostics,relMaintenance;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_auto_health);

        btnBack = (ImageButton)findViewById(R.id.btnBack);
        relDiagnostics = (RelativeLayout)findViewById(R.id.relDiagnostics);
        relMaintenance = (RelativeLayout)findViewById(R.id.relMaintenance);

        btnBack.setOnClickListener(this);
        relDiagnostics.setOnClickListener(this);
        relMaintenance.setOnClickListener(this);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.btnBack:
                finish();
                break;
            case R.id.relDiagnostics:
                intent = new Intent(this,DiagnosticsActivity.class);
                startActivity(intent);
                break;
            case R.id.relMaintenance:
