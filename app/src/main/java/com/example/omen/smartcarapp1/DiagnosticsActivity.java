...
public class DiagnosticsActivity extends AppCompatActivity implements View.OnClickListener {
    ImageButton btnBack;
    RelativeLayout relBattery,relCoolant,relElectrical,relMechanical;
    TextView navHeaderName,navHeaderCar;
    DrawerLayout mDrawerLayout;
    SharedPreferences sPref;
    SharedPreferences.Editor editor;
    Button btnDoDiagnostics, btnLastTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relBattery = (RelativeLayout)findViewById(R.id.relBattery);
        relCoolant = (RelativeLayout)findViewById(R.id.relCoolant);
        relElectrical = (RelativeLayout)findViewById(R.id.relElectrical);
        relMechanical = (RelativeLayout)findViewById(R.id.relMechanical);
        btnDoDiagnostics = (Button)findViewById(R.id.btnDoDiagnostics);
        btnLastTime = (Button)findViewById(R.id.btnLastTime);

        btnBack.setOnClickListener(this);
        relBattery.setOnClickListener(this);
        relCoolant.setOnClickListener(this);
        relElectrical.setOnClickListener(this);
        relMechanical.setOnClickListener(this);
        btnDoDiagnostics.setOnClickListener(this);
        ...
        btnLastTime.setText(sPref.getString("lastTime","ошибка"));
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.btnBack:
                finish();
                break;
            case R.id.btnDoDiagnostics:

                Toast.makeText(this,"диагностика сделана",Toast.LENGTH_SHORT).show();
                Date currentTime = Calendar.getInstance().getTime();
                DateFormat df = new SimpleDateFormat("dd/MMM/YYYY");
                String s = df.format(currentTime);
                editor.putString("lastTime","Последний раз: "+s);
                editor.commit();
                btnLastTime.setText(sPref.getString("lastTime","ошибка"));
                break;
            case R.id.relBattery:
                intent = new Intent(this,BatteryActivity.class);
                startActivity(intent);
                break;
            case R.id.relCoolant:
                intent = new Intent(this,CoolantActivity.class);
                startActivity(intent);
                break;
            case R.id.relMechanical:
                intent = new Intent(this,MechanicalActivity.class);
                startActivity(intent);
                break;
