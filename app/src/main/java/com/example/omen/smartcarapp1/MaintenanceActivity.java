...
public class MaintenanceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relTire = (RelativeLayout)findViewById(R.id.relTire);
        relOil = (RelativeLayout)findViewById(R.id.relOil);

        btnBack.setOnClickListener(this);

        relTire.setOnClickListener(this);
        relOil.setOnClickListener(this);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.relOil:
                ...
                break;
            case R.id.relTire:
                intent = new Intent(this,TireRotationActivity.class);
                startActivity(intent);
                break;
        }
    }
